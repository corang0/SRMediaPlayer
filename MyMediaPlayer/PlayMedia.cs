...
namespace MyMediaPlayer
{
    public unsafe class PlayMedia
    {
        ...
        public System.Windows.Controls.Grid grid4;
        public System.Windows.Controls.Button btnAudio,btnPlay;
        public System.Windows.Controls.Slider audioVol;
        ...
        [Obsolete]
        public int Init(string fileName, System.Windows.Controls.Image image, System.Windows.Controls.Image Dimage, System.Windows.Controls.Label startTime, System.Windows.Controls.Slider slider, System.Windows.Controls.GridSplitter splitter)
        {
            ...
            if (videoIndex > -1)
            {
                ...
                _ = image.Dispatcher.BeginInvoke((Action)(() =>
                   {
                       ...
                       grid4.Width = frameWidth;
                       slider.Width = frameWidth - 200;
                       //slider2.Width = frameWidth - 25;
                       btnPlay.Margin = new Thickness(40, -20, 0, 0);
                       slider.Margin = new Thickness(0,2,0,12);
                       btnAudio.Margin = new Thickness(frameWidth - 80, -20,0,0);
                       audioVol.Margin = new Thickness(frameWidth - 80, -135,25, 0);
                       splitter.Height = frameHeight;
        ...
        private unsafe void VideoDecodeTask()
        {
            ...
            if (mode == 0)
            {
                videoSRTask = new Thread(new ThreadStart(VideoSRTask));
                videoSRTask.Start();
            }
            else
            {
                videoSRTask = new Thread(new ThreadStart(VideoSRTask2));
                videoSRTask.Start();
            }
        ...
        private unsafe void VideoRasterTask()
        {
            ...
            while (true)
            {
                ...
                // if (System.IO.File.Exists("C:\\Users\\BONITO\\Anaconda3\\SRFBN_CVPR19\\results\\LR\\MyImage\\" + rastPos + ".bmp"))
                //      System.IO.File.Delete("C:\\Users\\BONITO\\Anaconda3\\SRFBN_CVPR19\\results\\LR\\MyImage\\" + rastPos + ".bmp");

                if(mode==2)
                       fPool.bitmap[rastPos].Save("C:\\Users\\BONITO\\Desktop\\output\\" + rastPos + ".bmp");
        ...
        private unsafe void VideoSRTask2()
        {
            ...
            while (true)
            {
             ...
             // Bitmap bmp_x4 = gmfn.Test_SR(fPool.bitmap[srpos]);

                fPool.bitmap[srpos].Dispose();
                fPool.bitmap[srpos] = gmfn.SR(srpos);
                //fPool.bitmap[srpos] = bmp_x4;
                //fPool.bitmap[srpos].Save(srpos + ".bmp");
                fPool.status[srpos] = FrameBuffer.eFrameStatus.F_SR;
